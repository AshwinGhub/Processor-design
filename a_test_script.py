...
dm_loc="C:/Users/Dell/Desktop/Arundhathy-files/Processor-design/memory_files/dm_file.txt"                          #Location of dm file - ../ indicates the folder "memory_files" where "dm_file.txt" is, is one folder up the current folder of script
memck_loc="C:/Users/Dell/Desktop/Arundhathy-files/Processor-design/test_instructions/"                              #Location of Instruction folder - file with instructions is in folder "Instructions" in the current folder of script
find=".memcheck"
file_name="o_p6.txt"                                                                    #Name of instruction file - default name "inst.txt"
